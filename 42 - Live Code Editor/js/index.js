...
function updateLiveCSSPreview(codeEditors) {
  const styleElement =
    livePreviewFrame.contentWindow.document.getElementById("live-preview-style");
...
function initializeCodeEditors() {
  ...
  const codeEditors = {
    html: CodeMirror(
      htmlEditor,
      getDefaultOptions({ mode: "text/html", value: "" })
    ),
    css: CodeMirror(
      cssEditor,
      getDefaultOptions({
    ...
    js: CodeMirror(jsEditor, getDefaultOptions({ mode: "javascript", value: "" }))
  };
...
function setupLivePreviewStudio() {
  ...
  // Event listener for change in JS editor
