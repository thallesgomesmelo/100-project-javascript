...
const pieColors = ["#1565c0", "#2196f3", "#1565c0", "#2196f3", "#1565c0", "#2196f3"];
...
// Spinner Count
let count = 0;
// 100 rotation for animation and last ratation for result
let resultValue = 101;
// Start spinning
